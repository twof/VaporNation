...
0
```
because a new version is created with each request. To stay safe, if you don't need to hold any information between requests, it's probably best to stick to nonsingleton versions of your own services.
