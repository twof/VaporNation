...
You can now configure your router to accept requests if the case of the request's path isn't quite right. This means that this code:
...
[p@calebkleveter](https://github.com/calebkleveter)
