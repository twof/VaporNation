...
It's very common to need to take the body of a request and decode it to an object, so to cut down on boilerplate, new methods were introduced to do that automatically on any HTTP method that accepted a body.
