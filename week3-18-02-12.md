...
In this talk [@Joannis](https://github.com/joannis) will cover the upcoming Vapor 3 release - a complete redesign aimed to be more configurable and performant with less boilerplate. He’ll also talk about dependency inversion as well the reactive pattern, codable and how these all fit together.
