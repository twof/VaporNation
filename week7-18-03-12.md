...
## News
RC2 was tagged for all packages last week, and with it, NIO now handles all all non-blocking async for Vapor! 🎉🎉🎉 If you want to know more about the impact of NIO, check out Tanner on Swift by Sundell and Week 5 of Vapor Nation. Many [API docs](https://api.vapor.codes) were also released this week. API docs are less like the tutorial style you'd find at [docs.vapor.codes](https://docs.vapor.codes) and more like traditional docs you'd find for other libraries and frameworks.
